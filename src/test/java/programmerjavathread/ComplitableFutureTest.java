...
public class ComplitableFutureTest {
    ...
    @Test
    void crate() throws ExecutionException, InterruptedException {
    ...
    @Test
    void complitionStage() throws ExecutionException, InterruptedException {
